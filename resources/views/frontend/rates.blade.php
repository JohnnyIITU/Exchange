    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="confer-leave-a-reply-form clearfix">
                <h4 class="mb-30">Currency Converter</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <input type="number" class="form-control mb-30" name="name" id="main_count" placeholder="Count" required>
                                    </div>
                                </div>
                                ...
                                <!-- Button -->
                                <div class="col-12">
                                    <button type="button" onclick="convert()" class="btn confer-btn">Convert</button>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="section-heading-2 text-center wow fadeInUp" data-wow-delay="300ms">
                    <p class="text-black-50">Actual on {{date('F d, Y', strtotime($localRates->created_at))}}</p>
                    <h4 class="text-black-50">Currency Rates</h4>
                </div>
            </div>
        </div>
        <div class="row">
...
<section class="ur-speaker-area bg-img bg-gradient-overlay section-padding-100">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="section-heading-2 text-center wow fadeInUp" data-wow-delay="300ms">
                    <p class="text-black-50">Actual on {{date('F d, Y', time())}}</p>
                    <h4 class="text-black-50">Currency Rates</h4>
                </div>
            </div>
        </div>
                            ...
                            <form>
                                <div class="contact_input_area">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control mb-30" name="name" id="lastname" placeholder="Last Name" required>
                                            </div>
                                        </div>
                                        <!-- Form Group -->
                                        <div class="col-12 col-lg-6">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <input type="number" class="form-control mb-30" name="name" id="count" placeholder="Count" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <div class="dropdown">
                                        ...
                                        <!-- Button -->
                                        <div class="col-12">
                                            <button type="button" onclick="send()" class="btn confer-btn">Send Message <i class="zmdi zmdi-long-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
