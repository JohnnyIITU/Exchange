        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6">
                <div class="about-content-text mb-80">
                    ...
                    <h3 class="wow fadeInUp" data-wow-delay="300ms">Lorem ipsum dolor.</h3>
                    <p class="wow fadeInUp" data-wow-delay="300ms">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur, doloribus, iste. A ab animi architecto assumenda commodi consequuntur corporis cum, debitis dicta doloribus facilis inventore iste laborum laudantium, minima non odio officia pariatur qui quidem repellendus rerum sed sint soluta tempore vel velit vero? Atque consectetur corporis, cum, dolor dolores eaque illo itaque mollitia non nulla quasi quisquam quod repudiandae.</p>
...
<section class="our-schedule-area bg-white" style="padding-top: 50px">
    <div class="col-12">
        <div class="schedule-tab">
            <!-- Nav Tabs -->
            <ul class="nav nav-tabs wow fadeInUp" data-wow-delay="300ms" id="conferScheduleTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="monday-tab" data-toggle="tab" href="#step-one" role="tab" aria-controls="step-one" aria-expanded="true">First</a>
                </li>
                <!-- Nav Item -->
                <li class="nav-item">
                    <a class="nav-link" id="tuesday-tab" data-toggle="tab" href="#step-two" role="tab" aria-controls="step-two" aria-expanded="true">Second</a>
                </li>
                <!-- Nav Item -->
                <li class="nav-item">
                    <a class="nav-link" id="wednesday-tab" data-toggle="tab" href="#step-three" role="tab" aria-controls="step-three" aria-expanded="true">Third</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" id="thursday-tab" data-toggle="tab" href="#step-four" role="tab" aria-controls="step-four" aria-expanded="true">Fourth</a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="single-contact--info text-center">
                                    ...
                                    <h5>ул. Толе би, 130б, между ул. Муканова и ТЦ "CityCenter"</h5>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="single-contact--info text-center">
                                    ...
                                    <h5>Ул. Гоголя, 92, уг.ул. Наурызбай батыра</h5>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="single-contact--info text-center">
                                    ...
                                    <h5>Район Ауэзовский Адрес мкр. 5, дом 17, пом. 67</h5>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="single-contact--info text-center">
                                    ...
                                    <h5> пр.Достык 89 (150 м выше ул.Сатпаева)</h5>
                                </div>
                            </div>
